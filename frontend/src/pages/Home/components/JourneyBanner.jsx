    ...
    secondaryGoals.length > 0
      ? Math.round(
          secondaryGoals.reduce(
            (total, goal) => total + (goal.progress || 0),
            0,
    ...
    return (
      <div className="journey-banner journey-banner-empty">
        <div className="journey-banner-content">
          <span className="journey-eyebrow">YOUR CAREER JOURNEY</span>

          <h2>Start building your future.</h2>

          <p>
            Set a career goal and turn it into something you can work toward
            every day.
          </p>

          <button onClick={onContinue}>Create Your Goal →</button>
        </div>
      </div>
    );
  }
    ...
    <div className="journey-banner">
      <div className="journey-banner-top">
        <div>
          ...
          <p>Keep building toward your next opportunity.</p>
        </div>

        <div className="journey-progress-number">{overallProgress}%</div>
      </div>
      ...
      {journeyStep && (
        <div className="journey-next">
          <div>
            ...
            <strong>{journeyStep.title}</strong>
